...
**For an update on the custom card creator Card Conjurer mentioned in this article see this update: [Running Card Conjurer Locally]({% post_url 2022-11-25-local-card-conjurer %})**
