...
I created the repo <https://github.com/axlan/ros_scratch> to capture my development. I organized my project into 4 ROS packages

# ar_framer

This package would take a camera feed, find the four corners of the target area and create a new image output snapped to the target area with the perspective fixed.
...
I started porting the calibration code and had to modify it to work without being able to wait for the position updates. This turned out the be very easy.
...
However, since I didn't fully flesh out this control system, so it is not currently working.
...
All in all I was able to implement the project in ROS and fully take advantage of the framework, but once again was limitted by the sensors, materials, and lack of time.